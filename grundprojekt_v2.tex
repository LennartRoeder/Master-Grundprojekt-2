...
\begin{document}
	...
	\HAWThesisProperties{Author={Lennart Karsten}
		,Title={Transition of a fullstack application to a microservice frontend}
		,EnglishTitle={Transition of a fullstack application to a microservice frontend}
	...
	{Diese Arbeit zeigt die Portierung einer fullstack Anwendung in ein AngularJS basiertes Frontend in einer Microservices Umgebung.}

...
\begin{document}
	...
	\HAWThesisProperties{Author={Lennart Karsten}
		,Title={Transition of a full-stack application\\
			to a micro-service front-end}
		,EnglishTitle={Transition of a full-stack application to a micro-service front-end}
	...
	\HAWAbstractPage
	%% English abstract
	{Microservices, Archikektur, Frontend, AngularJS}%
	{Diese Arbeit zeigt die Portierung einer full-stack Anwendung in ein AngularJS basiertes Frontend in einer Microservices Umgebung.}

...
%	\label{my-label}
	...
	\hline
	\textbf{Feature} & \textbf{Websuite} & \textbf{WebUI} \\ \hline
	...
	?? (The mapping view supports mapping of global parameters.) & no & yes \\ \hline
	?? (Global scenario parameters can be added and removed by the user) & no & yes \\ \hline \hline
